...
const grades = `<p>If you're wondering what I got for my results, my grades are below.<p>
<p>Blue highlight means that subject has dedicated information available, while green means it's available, but not dedicated just for that specific subject.<p>
<img src="https://content.fe.ibaguette.com/cdn/secure0/0430A590-F431-4AF8-8D0C-E94C7D42A926_SUSSY_AMOGUS_BEANS_HEHEHEHAW--------my_results_total_93.jpg?width=720&height=360" alt="my grades, if you can't see this then it's blocked, go to: https://media.discordapp.net/attachments/907318241498656850/1017125839462223892/0430A590-F431-4AF8-8D0C-E94C7D42A926.jpg">`

const html_geog_paper_1 = `<!DOCTYPE html>
<html>
...
const html_geog_paper_2 = `<!DOCTYPE html>
<html>
...
const html_geog_both_papers = `<!DOCTYPE html>
<html>
...
const html_computer_science = `<!DOCTYPE html>
<html>
...
const html_science_practicals = `<!DOCTYPE html>
<html>
...
const html_biology_braindump = `<!DOCTYPE html>
<html>
...
async function handleRequest(request) {
  if (request.url.toLowerCase() == "https://ibaguette.com/cheatsheets/gcse/geography/paper2") {
    return new Response(html_geog_paper_2, {
      headers: {
  ...
  if (request.url.toLowerCase() == "https://ibaguette.com/cheatsheets/gcse/geography/paper1and2") {
    const response = await fetch('https://raw.githubusercontent.com/Draggie306/CheatSheets/main/GCSE/Geography%20Paper%201%20%2B%202.html');
