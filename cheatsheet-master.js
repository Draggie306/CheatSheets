...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cheatsheet-assets.ibaguette.com/cheatsheet_browser_style.css"> <!-- Load intersitial cheatsheet browser CSS from replit, to prevent Cross-Origin Read Blocking (CORB) from GitHub -->
  ...
  document.getElementById("dark-mode-btn").addEventListener("click", function() {
    ...
    if (document.cookie.indexOf("audioPlayed=true") === -1) {
      ...
      var audio = new Audio('https://cheatsheet-assets.ibaguette.com/sounds/funny%20(15).mp3');
      audio.play();
    } else {
      // If the cookie exists, generate a random number and play the corresponding audio
      var randomNum = Math.floor(Math.random() * 16) + 1;
      var audio = new Audio('https://cheatsheet-assets.ibaguette.com/sounds/funny%20(' + randomNum + ').mp3');
      audio.play();
    }
  });
...
<html lang="en">
  <head>
    ...
    <link rel="preload" href="https://cheatsheet-assets.ibaguette.com/cheatsheet_browser_style.css" as="style">
    <link rel="preload" href="https://cheatsheet-assets.ibaguette.com/stackedit_style.css" as="style"> <!-- Preload main stackedit style for main cheat sheets! -->
    
	
	<!-- Load CSS from replit, to prevent Cross-Origin Read Blocking (CORB) from GitHub -->
	<link rel="stylesheet" href="https://cheatsheet-assets.ibaguette.com/cheatsheet_browser_style.css">
...
<body>
	...
	<div class="dropdown">
	  ...
	  <div class="dropdown-content">
		...
		<a href="https://ibaguette.com/cheatsheets/alevel/geography/all">[WORK IN PROGRESS] OCR Geography - PHYSICAL</a>
		<a href="https://ibaguette.com/cheatsheets/alevel/geography/all">[WORK IN PROGRESS] OCR Geography - HUMAN</a>
	  </div>
	</div>
	...
	<div class="dropdown">
	  ...
	  <div class="dropdown-content">
		...
		<a href="https://ibaguette.com/cheatsheets/gcse">Recap your GCSE knowledge</a>
	  </div>
	</div>
	...
	<div class="dropdown">
	  ...
	  <div class="dropdown-content">
		<a href="https://www.ibaguette.com/2023/04/introducing-french-revision-portal.html">The dedicated French Revision Portal is coming soon! Click here for more info.</a>
		...
		<a href="https://app.memrise.com/course/6381996/ndhs-as-vocab-family-structures/">(NEW) Family Vocab</a>
		<a href="https://app.memrise.com/course/6381998/ndhs-as-vocab-youth-trends/">(NEW) Youth Trends Vocab</a>
		<a href="https://padlet.com/hilla68/alevel-french-with-eduqas-n7vewglwvuj28euw">Mme Hill's Padlet</a>
		<a href="https://app.memrise.com/communicate">(NEW) Memrise AI Chat</a>
		<a href="https://www.youtube.com/playlist?list=PL5xtnB--9zERtoI-yN_t0YlWtaFmx10eu">French Listening Playlist</a>
		<a href="https://www.youtube.com/@HugoDecrypte">HugoDécrypte - Actus du jour</a>
		<a href="https://www.youtube.com/@HugoDecrypte2/videos">HugoDécrypte - Extended Listening Practice</a>
	  </div>
	</div>
...
<html lang="en">
  <head>
    ...
    <link rel="preload" href="https://cheatsheet-assets.ibaguette.com/cheatsheet_browser_style.css" as="style">
    <link rel="preload" href="https://cheatsheet-assets.ibaguette.com/stackedit_style.css" as="style"> <!-- Preload main stackedit style for main cheat sheets! -->
    <link rel="stylesheet" href="https://cheatsheet-assets.ibaguette.com/cheatsheet_browser_style.css"> <!-- Load index CSS from replit, to prevent Cross-Origin Read Blocking (CORB) from GitHub -->
